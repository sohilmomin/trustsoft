...
class SignUp extends Component {
    ...
    handleSubmit(values) {
        this.props.signUp(values.name, values.email, values.password)
    }
    render() {
        return (
                    ...
                    <div className='col-12 col-lg-6 pl-0 align-self-center'>
                        <div className='row'>
                            <div className='col-lg-8 col-12 m-auto signup-block'>
                                <h1 className='text-center auth-heading mt-5'>SignUp</h1>
                                <LocalForm onSubmit={this.handleSubmit} row>
                                    ...
                                    <FormGroup row>
                                        <Col md={{ size: 12 }} className='text-center m-auto'>
                                            <Button type='submit' className='btn-block signup-btn' >SIGN UP</Button>
                                        </Col>
                                    </FormGroup>
                                </LocalForm>
                                <div className='auth-link-block'>
                                    <p className='mb-1'><a href="#" className='auth-link'>Forget Password?</a></p>
                                    <p className='mb-3'>Already have an account?<a href="/signin" className='auth-link'>Sign In</a></p>
